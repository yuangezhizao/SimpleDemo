<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Web.aspx.cs" Inherits="WebAppClinet.Web" %>
...
<body>
    ...
    <script>
        function ajaxLogin() {
            InvokeService('<%=ResolveUrl("http://localhost:62330/api/auth")%>',
        ...
        function helloService() {
            InvokeService('<%=ResolveUrl("http://localhost:62330/api/users")%>',
