...
//                ? authClient.ProcessUserAuthorization((System.Web.HttpRequestBase)authService.Request.ToHttpRequestBase())
...
//            };
//            //申请访问令牌
//            var authState = ProcessUserAuthorization(authClient, authServer, authService);  //获取证书
//            if (authState == null)
//            {
//                try
//                {
...
//                    //authClient.RequestUserAuthorization(this.Scopes);
